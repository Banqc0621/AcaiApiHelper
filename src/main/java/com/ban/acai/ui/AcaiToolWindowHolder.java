 ...
 *
 * <p>因为这两个面板在 {@link AcaiToolWindowFactory#createToolWindowContent} 中以局部变量创建，
 ...
 */
public final class AcaiToolWindowHolder {
    ...
    public static AcaiToolWindowHolder getInstance(@NotNull Project project) {
        return project.getService(AcaiToolWindowHolder.class);
    }
}